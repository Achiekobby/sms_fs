        ...
        <div class="login-wrapper">
            <div class="login-content">
                <div class="login-userset">
                    ...
                    <form action="{{ route('store.staff-login') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-login">
                            <button class="btn btn-success" style="width: 100%; padding:10px 0; margin-top:30px;" type="submit" name="login">Sign In</button>
            ...
            <div class="login-img">
                <img src="{{ asset('assets/img/staff_login.png') }}" alt="img" />
            </div>
        </div>
    </div>
@endsection
